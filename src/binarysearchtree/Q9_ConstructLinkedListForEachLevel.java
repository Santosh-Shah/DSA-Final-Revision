...
public class Q9_ConstructLinkedListForEachLevel {
...
//        BinaryTreeNode<Integer> root = takeInputBetter(true, 0, false);
        ...
        printDetailed(root);
        ArrayList<Node<Integer>> linkedLists = constructLinkedListForEachLevel(root);

        for (Node<Integer> head : linkedLists) {
            while (head != null) {
    ...
    // TODO: method to construct linked-list for each level
